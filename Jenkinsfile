pipeline {
	...
	stages {
		...
		stage("k8s Deployment"){
			steps {
				script {
					withKubeConfig(caCertificate: '', clusterName: '', contextName: '', credentialsId: 'kube-cred', namespace: '', restrictKubeConfigAccess: false, serverUrl: 'https://api-kelvin-kops-k8s-local-ur1u22-f0152b478b0bb24d.elb.us-east-1.amazonaws.com') {
